---
title: "Day 2, part 1: Introduction to R(Studio)"
...
It is a **free**, **open-source** and **cross-platform** programming 
...
It produces beautiful **data vizualisations**! `r emo::ji("chart increasing")`
...
`r countdown::countdown(minutes = 10, color_running_background = "#6CC24A", color_running_text = "black", color_finished_background = "#E03C31", color_finished_text =  "grey30")`
